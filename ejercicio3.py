...
titulo = Label(frame_entrada, text= "Ejercicio 3")
...
subtitulo2 = Label(frame_entrada,  text="Numeros inversos")
...
etiq_a=Label(frame_entrada, text="inserte 4 digitos= ")
...
bt_sum= PhotoImage(file="invertir.png")
